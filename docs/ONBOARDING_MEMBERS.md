...
This guide is for CSA members using the points system.
...
- Scan the QR code at the event, or open the provided check-in link.
- Confirm the event details and submit check-in.
