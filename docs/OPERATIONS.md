...
| Create event                           | Officer/Admin/Parent | `/officer/events/new` (parents: JT Event / Mixer only)            |
| Howdy Week guest CSV                   | Officer/Admin/Parent | `/officer/events/[id]` (Howdy Week category)                      |
| Howdy Week Guests (outreach)           | Officer/Admin/Parent | `/officer/members?tab=guests`                                     |
| Officer check-in                       | Officer/Admin/Parent | `/officer/events/[id]/checkin`                                    |
...
| Browse / filter events                 | Officer/Admin/Parent | `/officer/events`                                                 |
| Edit event date / time / location      | Officer/Admin/Parent | `/officer/events/[id]` → When and Where                           |
| Delete event                           | Officer/Parent/Admin | `/officer/events` (officers: non-JT Event/Mixer; parents: their JT Event/Mixer; admin: any) |
| Manage member roles                    | Admin            | `/admin/members?tab=roles`                                        |
| Look up member points / sign-in status | Officer/Admin/Parent | `/officer/members`                                                |
...
3. Choose the access role (`Member`, `Officer`, or `Admin`) and the **Parent** checkbox, then click **Save**.
